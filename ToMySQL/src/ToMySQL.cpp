...
int mainMenu() {
	...
	cout << "\nMenu Options" << endl << "1 Print All Account"
		 << endl << "2 - Open new Account" << endl << "3 - Withdraw" << endl << "4 - Deposit"
		 << endl << "5 - Close Account" << endl << "6 - End Transaction" << endl;
...
int main(int argc, char** argv) {
	...
	BankTransaction* bt = new BankTransaction("localhost", "root", "mysql", "mybank");
	...
	while(1) {
		...
		case WITHDRAW:
			...
			break;
		case DEPOSIT:
			cout << "\nEnter eccount no, amount to deposit" << endl << "? ";
			cin >> acno;
			cin >> bal;
			if(bal < 0) {
				cout << "Invalid amount" << endl;
